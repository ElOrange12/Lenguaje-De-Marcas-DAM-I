...
<html lang="es">
	<head>
		<title>Tienda</title>
		<style>
			body, html{padding:0px;margin:0px;font-family:ubuntu;width:100%;height:100%;}
			body{display:flex;flex-direction:column;justify-content:space-between;}
			header, footer{background:black;color:white;padding:10px;text-align:center;}
	...
	<script>
		...
		/////// Atrapa porductos y los mete en el carro ///////
